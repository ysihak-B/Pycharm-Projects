...
class OBJ:
    def __init__(self, filename, i, num=1):
        self.vertices = self.loadMesh(filename)
        self.vertex_count = len(self.vertices)
        self.vertices = np.array(self.vertices, dtype=np.float32)

        self.vao = glGenVertexArrays(num)
        glBindVertexArray(self.vao[i])
        self.vbo = glGenBuffers(num)
...
class Texture:
    ...
    def __init__(self, filepath, i, num=1):
        self.texture = glGenTextures(num)
...
class App:
    def __init__(self):
        ...
        self.cube_mesh = OBJ("checker_board.obj")
        self.wood_texture = Texture("images/checkers_texture.jpg")
