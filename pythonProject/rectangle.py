...
def init():
    ...
    vertexShaderContent = getFileContents(
        'Ysihak_Bazezew_UGR_1131_12_3/Ysihak_Bazezew_UGR_1131_12_3_rectangle/triangle.vertex.shader')
    fragmentShaderContent = getFileContents(
        'Ysihak_Bazezew_UGR_1131_12_3/Ysihak_Bazezew_UGR_1131_12_3_rectangle/triangle.fragment.shader')
    ...
    vertices = np.array([
        ...
        [-0.5, -0.5, -0.5, 1.0, 0.0, 0.0]], dtype=np.float32)
